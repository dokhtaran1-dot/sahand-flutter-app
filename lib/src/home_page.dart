    ...
    return Scaffold(
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          // Master artwork aspect ratio: 941 x 1672.
          const designW = 941.0;
          const designH = 1672.0;
          final imageScale = (screenW / designW) > (screenH / designH)
              ? (screenW / designW)
              : (screenH / designH);
          ...
          Rect zone(double x, double y, double w, double h) => Rect.fromLTWH(
                left + x * imageScale,
                top + y * imageScale,
                w * imageScale,
                h * imageScale,
          ...
          return ClipRect(
            child: Stack(
              children: [
                ...
                // RM — keep artwork untouched; only invisible tap target.
                Positioned.fromRect(
                  rect: rmZone,
                  child: _TapZone(
                ...
                // RC — keep artwork untouched; only invisible tap target.
                Positioned.fromRect(
                  rect: rcZone,
                  child: _TapZone(
                ...
                // RV — opens the Royal Village screen.
                Positioned.fromRect(
                  rect: rvZone,
                  child: _TapZone(
